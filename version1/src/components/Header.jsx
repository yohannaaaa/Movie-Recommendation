...
const Header = () => {
     ...
     const getMovie = () => {
       fetch(`https://api.themoviedb.org/3/search/?movie=${searchValue}/api_key=b29d04ec0a55cae1d636f5a70f64bedf`)
         .then(res => res.json())
...
//     const [moviess, setMovies] = useState([]);
//     const [searchValue, setSearchValue] = useState('');
// `https://api.themoviedb.org/3/search/?movie=${searchValue}/api_key=b29d04ec0a55cae1d636f5a70f64bedf`);
