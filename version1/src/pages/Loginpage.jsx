...
<div className='container'>
  ...
  {/* input field*/}
    ...
    <div className="input">
              ...
              />
              <span onClick={togglePasswordVisibility}>{showPassword ? <FaRegEyeSlash/> : <FaRegEye/>}</span>
            </div>
   ...
   {action==="Sign Up"?<div></div>:<div className="forgot-password">Forgotten <span>Password?</span></div>}
